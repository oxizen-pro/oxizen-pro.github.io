...
(function($) {
  ...
  $(document).ready(function (){
    ...
    $(function() {
      var endDate = "December 28, 2016 20:39:00";
      $('.lj-countdown .row').countdown({
        date: endDate,
        render: function(data) {
          $(this.el).html('<div><div><span>' + this.leadingZeros(data.days, 2) + '</span><span>дней</span></div><div><span>' + this.leadingZeros(data.hours, 2) + '</span><span>часов</span></div></div><div class="lj-countdown-ms"><div><span>' + this.leadingZeros(data.min, 2) + '</span><span>минут</span></div><div><span>' + this.leadingZeros(data.sec, 2) + '</span><span>секунд</span></div></div>');
        }
      });
    });
